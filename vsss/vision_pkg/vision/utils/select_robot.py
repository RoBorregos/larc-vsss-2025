...
def select_robot(past_robots_secondary_color, detected_robots, tf_helper, get_eucladian):
    '''
    ...
    '''
    robot_list = []
    for past_robot in past_robots_secondary_color:
            possibilities = []
            same_id = []
            same_color = []
            same_team = []
            ...
            tf_helper("robot" + str(selected_robot.id) + "_base_link", selected_robot.location[0], selected_robot.location[1], roll, pitch, yaw)
