...
//Wi-Fi credentials
const char* ssid = "EXAMPLE_SSID"; // Replace with your Wi-Fi SSID'";
const char* password = "EXAMPLE_PASSWORD"; // Replace with your Wi-Fi password
...
//Outdated example of a motor drive function 
/*
...
void loop() {
  ...
  if (packetSize) {
    ...
    if (len == 8) {
      ...
      memcpy(&RPM, incomingPacket, 4);
      memcpy(&RPM2, incomingPacket + 4, 4);
